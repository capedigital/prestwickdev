                                        ...
                                        data.Products.forEach(function(product) {
                                            ...
                                            if (typeof product.Results.Document.paperback_pb !== 'undefined') {
                                                if (product.Results.Document.paperback_pb == '1') {
                                                    if (product.Results.Document.price25 != undefined) {
                                                        price = product.Results.Document.price25;
                                                    } else if (product.Results.Document.hawk_child_attributes_hits !== undefined) {
                                                        if (product.Results.Document.hawk_child_attributes_hits.length > 0) {
                                                            product.Results.Document.hawk_child_attributes_hits[0].Items.forEach(function(item) {
                                                                if (item.skuprice25 !== undefined) {
                                                                    price = item.skuprice25;
                                                                }
                                                            });
                                                        }
                                                    } else {
                                            ...
                                            markup += '<a data-suggest-type="3" href="' + productURL + '">';
                                                markup += '<div class="row autocomplete-result autocomplete-product">';
                                                    ...
                                                    markup += '<div class="column xsm-20">';
                                                        ...
                                                        if (price_reduced && (price_formatter.format(retail_price) > price_formatter.format(price))) markup += '<strike><strong>Retail Price:</strong> ' + price_formatter.format(retail_price) + '</strike><br>';
            ...
            data.Results.forEach(function(searchResult) {
                ...
                if (typeof searchResult.Document.paperback_pb !== 'undefined') {
                    if (searchResult.Document.paperback_pb == '1') {
                        if (searchResult.Document.price25 != undefined) {
                            price = searchResult.Document.price25;
                        } else if (searchResult.Document.hawk_child_attributes_hits !== undefined) {
                            if (searchResult.Document.hawk_child_attributes_hits.length > 0) {
                                searchResult.Document.hawk_child_attributes_hits[0].Items.forEach(function(item) {
                                    if (item.skuprice25 !== undefined) {
                                        price = item.skuprice25;
                                    }
                                });
                ...
                if (price_reduced && (price_formatter.format(retail_price) > price_formatter.format(price))) list_markup += '<strike><strong>Retail Price:</strong> ' + price_formatter.format(retail_price) + '</strike><br>';
